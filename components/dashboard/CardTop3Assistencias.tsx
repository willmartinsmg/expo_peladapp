...
interface CardTop3AssistenciasProps {
    ...
    <View style={styles.card}>
        ...
        <View style={styles.headerLeft}>
          ...
          <View style={styles.headerText}>
            <Text style={styles.title}>
              {customTitle || 'Top 3 assistentes das últimas 5 semanas'}
            </Text>
      ...
      {loading ? (
          ...
          {players.map((player, index) => (
            <View key={player.userId} style={styles.playerRow}>
              ...
              <View style={styles.playerRight}>
                <Text style={styles.assistsCount}>{player.totalAssists}</Text>
                <Text style={styles.assistsLabel}>
                  {player.totalAssists === 1 ? 'assistência' : 'assistências'}
                </Text>
                {player.totalGoals > 0 && (
                  <Text style={styles.goalsInfo}>
                    + {player.totalGoals} {player.totalGoals === 1 ? 'gol' : 'gols'}
                  </Text>
                )}
              </View>
            </View>
        ...
        <Text style={styles.emptyText}>
          Nenhuma assistência registrada nas últimas 5 semanas.
        </Text>
      )}
...
export default CardTop3Assistencias
